...
+ 终端测试：linux下使用，例如：
```
curl -H "Content-type: application/json" -X POST --data '{"Token": "1222333", "ClinicCode": "81000000007", "Point":100, "Description":"dd","QueryType":2,"Comment":"dd","Channel":"001"}'  "http://127.0.0.1:5000/api/v1/point/handle/createPoint"
```
